                       ...
                       <div className=" ">
                           ...
                           <span className="text-muted-foreground">{averageReview.toFixed(2)}</span>
                               ...
                               <div  className="mt-5 mb-5">
                                {
                                  productDetails?.totalStock===0  ?  <Button   className="w-full opacity-60 cursor-not-allowed">
                                     out of Stock
                                      </Button> : <Button onClick={()=>handaleAddtoCard(productDetails?._id,productDetails?.totalStock)}  className="w-full"> Add to card </Button>
                                }
                               </div>
                        <Separator/>  
                          ...
                          <h2 className="text-xl font-bold mb-4">Reviews</h2>
                            ...
                            <div className="mt-10 flex-col flex gap-2">
                               <Label>Write a review</Label>
                                ...
                                <Button onClick={handleAddReview} disabled={reviewMsg.trim()===""}>Sumbit</Button>
